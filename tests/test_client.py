"""Tests for client management — exclusive access, queue, grace period."""
...
async def test_first_client_acquires():
    ...
    mgr = ClientManager(grace_period=10.0)
...
async def test_queue_positions_update_after_promotion():
    ...
    mgr.acquire("client-3")  # position 2
...
async def test_grace_period_expired():
    ...
    mgr = ClientManager(grace_period=0.01)
